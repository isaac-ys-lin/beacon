...
enum BatteryHubAppearanceTheme: String, CaseIterable, Identifiable {
    static let defaultsKey = "BatteryHub.appearanceTheme"
    ...
    static func resolved(rawValue: String) -> BatteryHubAppearanceTheme {
        BatteryHubAppearanceTheme(rawValue: rawValue) ?? .system
    }
