...
enum StatusWindowPreferences {
    static let showMenuBarBatteryKey = "Beacon.showMenuBarBattery"
    static let didChangeNotification = Notification.Name("Beacon.statusWindowPreferencesDidChange")
